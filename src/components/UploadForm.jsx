  ...
  return (
    <form onSubmit={onSubmit} className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          <label className="block text-sm mb-1">Fecha de Radicacion</label>
          <input
            read                             // ← ahora es solo lectura
            className="w-full border rounded px-3 py-2 bg-slate-100 text-slate-700 "
            placeholder="Fechas cuentas de cobros"
            aria-readonly="true"
          />
