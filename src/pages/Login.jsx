      ...
      <section className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <form onSubmit={onSubmit} className="bg-white p-6 rounded-2xl shadow border space-y-3">
            ...
            <div>
              <label className="block text-sm mb-1 text-[color:rgba(10,42,77,.8)]">Usuario</label>
              <input
                className="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-sky-500/50"
            ...
            <div>
              <label className="block text-sm mb-1 text-[color:rgba(10,42,77,.8)]">Contraseña</label>
              <input
                type="password"
                className="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-sky-500/50"
                placeholder="••••••••"
            ...
            {/* BOTÓN CON DOBLE COLOR (fallback + marca) */}
            <button
              type="submit"
              className="
                w-full flex items-center justify-center rounded-lg py-2 font-semibold text-white shadow-sm
                bg-sky-600 hover:bg-sky-700 active:bg-sky-800
                bg-[var(--ps-blue)] hover:brightness-95
              "
            >
              Iniciar sesión
            </button>

            <p className="text-sm text-[color:rgba(10,42,77,.75)]">
              ¿No tienes cuenta?{" "}
              <Link className="text-[color:var(--ps-orange)] hover:underline" to="/register">Regístrate</Link>
            </p>
          </form>
          ...
          <div className="hidden md:block">
            ...
            <p className="mt-3 text-sm text-[color:rgba(10,42,77,.75)]">
